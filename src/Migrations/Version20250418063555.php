...
final class Version20250418063555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sylius_cms_block_channels (block_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_7026602FE9ED820C (block_id), INDEX IDX_7026602F72F5A1AA (channel_id), PRIMARY KEY(block_id, channel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_block_products (block_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_3088D8C3E9ED820C (block_id), INDEX IDX_3088D8C34584665A (product_id), PRIMARY KEY(block_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_block_taxons (block_id INT NOT NULL, taxon_id INT NOT NULL, INDEX IDX_5397DD03E9ED820C (block_id), INDEX IDX_5397DD03DE13F470 (taxon_id), PRIMARY KEY(block_id, taxon_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_block_products_in_taxons (block_id INT NOT NULL, taxon_id INT NOT NULL, INDEX IDX_B4D0B7CEE9ED820C (block_id), INDEX IDX_B4D0B7CEDE13F470 (taxon_id), PRIMARY KEY(block_id, taxon_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sylius_cms_media_channels (media_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_2538B272EA9FDD75 (media_id), INDEX IDX_2538B27272F5A1AA (channel_id), PRIMARY KEY(media_id, channel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sylius_cms_page_channels (page_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_E8AF4F7FC4663E4 (page_id), INDEX IDX_E8AF4F7F72F5A1AA (channel_id), PRIMARY KEY(page_id, channel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sylius_cms_section (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(250) NOT NULL, name VARCHAR(250) DEFAULT NULL, type VARCHAR(250) DEFAULT NULL, UNIQUE INDEX UNIQ_D4DD0C0777153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_section_pages (section_id INT NOT NULL, page_id INT NOT NULL, INDEX IDX_2C0728F8D823E37A (section_id), INDEX IDX_2C0728F8C4663E4 (page_id), PRIMARY KEY(section_id, page_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_section_blocks (section_id INT NOT NULL, block_id INT NOT NULL, INDEX IDX_5DE81928D823E37A (section_id), INDEX IDX_5DE81928E9ED820C (block_id), PRIMARY KEY(section_id, block_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_section_media (section_id INT NOT NULL, media_id INT NOT NULL, INDEX IDX_665F6C81D823E37A (section_id), INDEX IDX_665F6C81EA9FDD75 (media_id), PRIMARY KEY(section_id, media_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_cms_template (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(250) DEFAULT NULL, type VARCHAR(250) DEFAULT NULL, content_elements JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
